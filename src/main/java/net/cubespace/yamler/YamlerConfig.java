...
import net.cubespace.yamler.Comments;
import net.cubespace.yamler.ConfigSection;
import net.cubespace.yamler.IConfig;
import net.cubespace.yamler.MapConfigMapper;
...
public class YamlerConfig extends MapConfigMapper implements IConfig {
    ...
    private void internalSave(Class<?> clazz) throws YamlerConfigurationException {
        if (!clazz.getSuperclass().equals(net.cubespace.yamler.YamlerConfig.class)) {
